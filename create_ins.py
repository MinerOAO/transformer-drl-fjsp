...
def main():
    ...
    case = CaseGenerator(num_jobs, num_mas, opes_per_job_min, opes_per_job_max, flag_same_opes=False, flag_doc=True, path="data_util_gen/")
    gymnasium.make('fjsp-v0', case=case, env_paras=env_paras)  # Instances are created when the environment is initialized
